 ...
 #   data = request.json
  #  print("Datos recibidos en la solicitud POST:", data)
   ...
   # longitud = data.get('longitud')
    ...
    # Insertar los datos en la base de datos MySQL
    #cursor = db.cursor()
    #insert_query = "INSERT INTO coordenadas (latitud, longitud, altitud, timestamp, speed, rpm) VALUES (%s, %s, %s, %s, %s, %s)"
    #data_tuple = (latitud, longitud, altitud, timestamp, speed, rpm)
    #cursor.execute(insert_query, data_tuple)
    #db.commit()
    #cursor.close()
